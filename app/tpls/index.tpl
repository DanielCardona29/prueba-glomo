...
<head>
  ...
  <title>app-col-challenge-january</title>
  ...
  <meta name="application-name" content="app-col-challenge-january">
  <link rel="icon" sizes="192x192" href="resources/images/touch/chrome-touch-icon-192x192.png">

  <!-- Add to homescreen for Safari on iOS -->
  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="apple-mobile-web-app-status-bar-style" content="black">
  <meta name="apple-mobile-web-app-title" content="app-col-challenge-january">
